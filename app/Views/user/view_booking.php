            ...
            <div class="card-body">
                ...
                <?php if ($booking['status'] == 'confirmed'): ?>
                    <div class="alert alert-primary">
                        <i class="fas fa-info-circle"></i> Your order is confirmed and will be delivered at the scheduled time.
                    </div>
                <?php elseif ($booking['status'] == 'pending'): ?>
                    <div class="alert alert-warning">
                        <i class="fas fa-clock"></i> Your order is pending confirmation. We will update you soon.
                    </div>
